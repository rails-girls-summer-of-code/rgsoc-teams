  ...
  factory :application do
    ...
    trait :for_project do
      ...
      application_data {{
        ...
        'student0_application_language_learning_period': StudentFields::MONTHS_LEARNING.sample,
        ...
        'student1_application_language_learning_period': StudentFields::MONTHS_LEARNING.sample
      }}
    end
